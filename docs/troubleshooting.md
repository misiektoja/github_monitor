...
Verbose mode answers "what did the tool decide?" It expands the startup summary and states when missing data prevents a specific alert from firing during the current check:
